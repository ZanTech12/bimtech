...
export default function JambCbtContent() {
  return (
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-brand-950 tracking-tight">Real JAMB Exam Experience</h2>
            <p className="mt-3 text-slate-500 max-w-xl mx-auto">Our CBT interface mirrors the exact JAMB UTME environment.</p>
          </div>
          <div className="max-w-4xl mx-auto bg-slate-50 rounded-2xl border border-slate-200 p-8">
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200">
              ...
              <div className="px-3 py-1 bg-red-50 text-red-600 text-xs font-semibold rounded">01:59:42</div>
            </div>
